                    ...
                    <div class="col-xl-7">
                        <div class="row g-3  mega-inline card">
                                        ...
                                        <div class="list-group" id="list-tab" role="tablist">
                                            <?php foreach ($pengajuan->pengajuan->persyaratan as $n => $p) { ?>
                                                <a class="list-group-item list-group-item-action list-hover-primary"
                                                    id="list-home-list<?= $p->id ?>" data-bs-toggle="list"
                                                    href="#list-home<?= $p->id ?>" role="tab"
                                    ...
                                    <div class="col-sm-7">
                                        <div class="tab-content" id="nav-tabContent">
                                            <?php foreach ($pengajuan->pengajuan->persyaratan as $m => $c) { ?>
                                                <div class="tab-pane fade list-behaviors" id="list-home<?= $c->id ?>"
                                                    role="tabpanel" aria-labelledby="list-home-list<?= $c->id ?>">
                                                        ...
                                                        <?php if ($f->persyaratan_id == $c->id) { ?>
                                                            <div class=" align-items-center list-light-dark contact-profile p-3">
                                                                <ul class="d-flex flex-column gap-2">
                                                                    ...
                                                                    <li>
                                                                        <a target="_blank" href="<?= base_url($f->berkas) ?>"
                                                                            class="btn btn-primary btn-sm">Download</a>
                                                                    </li>
                                                                </ul>
                                                                <form novalidate
                                                                    action="<?= base_url("/pemeriksaan/save_resp_persyaratan") ?>"
                                                                    method="post"
                                                                    class="needs-validation row mt-4 d-flex flex-column gap-2">
                                                                    <input type="hidden" value="<?= $f->id ?>" name="id">
                                                                    <div class="form-group">

                                                                        <label for="">Tulis Catatan</label>
                                                                        <textarea cols="20" class="form-control form-textarea"
                                                                            placeholder="Contoh : Berkas sudah sesuai" required
                                                                            name="catatan"><?= $f->catatan ?></textarea>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="">Tanggal Diperiksa</label>
                                                                        <input value="<?= $f->tanggal_diperiksa ?>" required
                                                                            type="date"
                                                                            class="form-control flatpickr-input datetime-local"
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select required name="status"
                                                                            ...
                                                                            <option <?= ($f->status == 1) ? "selected" : "" ?>
                                                                                value="1">Diterima</option>
                                                                            <option <?= ($f->status == 2) ? "selected" : "" ?>
                            ...
                            <div class="card-footer text-end">
                                <a class="btn btn-secondary" href="<?= base_url("/pemeriksaan") ?>"><i
                                        class="fa fa-arrow-left"></i> Kembali</a>
                                <a class="btn btn-success"
                                    href="<?= base_url("/pemeriksaan/done/" . $pengajuan->id) ?>"><i
                                        class="fa fa-check"></i> Pemeriksaan Selesai</a>
                            </div>
                        </div>
                    </div>
                </div>
