        ...
        <div class="edit-profile">
            <div class="row">
                <div class="d-flex justify-content-center">
                    <div class="col-xl-5">
                        <form accept="<?= base_url('referensi/edit_pengajuan/' . $pengajuan->id) ?>" class="row g-3 needs-validation mega-inline card" novalidate="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea minlength="100" required name="deskripsi" cols="10" rows="5" class="form-control" placeholder="Deskripsikan Pengajuan Ini. Contoh : Pengajuan untuk pegawai yang akan pensuin ..."><?= $pengajuan->deskripsi ?></textarea>
