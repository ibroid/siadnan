<div class="shipping-info">
  <h5>Edit User </h5>
  <form action="<?= base_url('settings/save_user/' . R_Input::gett('edit_user')) ?>" class="row g-3 needs-validation mega-inline" novalidate="" method="POST">
    <div class="col-xxl-12 col-sm-12">
      <label class="form-label" for="validation-firstname-wizard">Identifier<span class="txt-danger">*</span></label>
      <input value="<?= $user->identifier ?>" minlength="5" name="identifier" class="form-control" id="validation-firstname-wizard" type="text" placeholder="Enter first name" required="">
    ...
    <div class="col-xxl-12 col-sm-12">
      ...
      <input minlength="8" name="login[password]" class="form-control" id="validation-lastname-wizard" type="password" placeholder="Enter last name">
      <div class="show-hide"><span class="show"> </span></div>
      <div class="invalid-tooltip">Check Again!</div>
      <div class="valid-tooltip">Looks good!</div>
      <small class="text-danger">Kosongkan password apabila tidak perlu perubahan</small>
    </div>
    <?php if ($user->id != 1) { ?>
        ...
        <div class="card">
          <div class="media p-20">
            <div class="form-check radio radio-secondary m-0 w-100">
              <input <?= ($user->level == 'Operator') ? 'checked' : '' ?> required class="form-check-input" id="radio21" type="radio" name="level" value="3">
        ...
        <div class="card">
          <div class="media p-20">
            <div class="form-check radio radio-primary m-0 w-100">
              <input <?= ($user->level == 'Administrator') ? 'checked' : '' ?> required class="form-check-input" id="radio22" type="radio" name="level" value="2">
    ...
    <div class="col-xxl-12 col-sm-12">
      ...
      <input value="<?= $user->profile->nama_lengkap ?>" minlength="5" class="form-control" id="validation-profile-wizard" type="text" placeholder="" required="">
      <input type="hidden" value="<?= $user->profile_id ?>" required id="hidden-profile-id" name="profile_id">
